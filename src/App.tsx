    ...
    <div className="app-container">
      ...
      <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[860px] bg-matte-gray/90 backdrop-blur-xl border-t border-white/10 p-4 flex justify-around items-center z-40 shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
        <button 
          ...
          className={`p-3 transition-all ${currentView === 'list' && !editingNote ? 'text-orange-accent scale-125' : 'text-gray-500 hover:text-gray-300'}`}
        >
          <Search size={28} />
        </button>
        ...
        <button 
          ...
          className={`p-4 bg-orange-accent rounded-full text-black shadow-[0_0_20px_rgba(255,107,0,0.3)] transition-all hover:scale-110 active:scale-95 -translate-y-4`}
        >
